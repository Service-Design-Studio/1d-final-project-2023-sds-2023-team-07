...
RSpec.describe TransactionsController, type: :controller do
  ...
  describe "GET #index" do
    ...
    it "returns a table of transactions for the user" do
      transaction1 = ["amount", "50.0"], ["atm_machine_id", 1], ["created_at", "2023-06-22T07:15:27.061Z"], ["id", 10], ["transaction_type", 0], ["transaction_types", nil], ["updated_at", "2023-06-22T07:15:27.061Z"], ["user_id", 3]
      ...
      expect(JSON.parse(response.body)[0]).to eq(expected_response)
    end
