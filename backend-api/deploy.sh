...

{
  ...
  docker build -t gcr.io/backend-dbs-grp7/backend-dbs-grp7 . --no-cache && echo -e "\n\033[1;32mDocker image built successfully!\033[0m" >&3
  ...
  docker push gcr.io/backend-dbs-grp7/backend-dbs-grp7 && echo -e "\n\033[1;32mDocker image pushed successfully!\033[0m" >&3

  echo -e "\n\033[1;33mDeploying the Docker image to Cloud Run...\033[0m" >&3
  gcloud run deploy backend-dbs-grp7 --image gcr.io/backend-dbs-grp7/backend-dbs-grp7 --platform managed --region asia-southeast1 --allow-unauthenticated && echo -e "\n\033[1;32mDocker image deployed to Cloud Run successfully!\033[0m" >&3
} &
s
