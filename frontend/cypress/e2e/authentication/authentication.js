...
Given(
  "the user is at the transaction history page with the deposit and withdraw buttons",
  () => {
...
Then(
  'the user will receive an "Authentication Failed, incorrect user" message',
  () => {
...
Then("he will be directed to a success page", () => {
  cy.contains("RETURN TO HOMEPAGE");
});
